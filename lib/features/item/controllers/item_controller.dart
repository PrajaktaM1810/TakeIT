...
//   int? _pricePerUnit = 1;
//   int? get pricePerUnit => _pricePerUnit;
...
//   static double getPricePerUnit(String? userType, Item? item) {
//     print("Sidddddd UserType: $userType");
//     print("Sidddddd item: $item");
//     print("Sidddddd item: ${item!.superstorePrice}");
//     if (item == null || userType == null) return 0.0;

//     switch (userType) {
//       case 'Single User':
//         return item.singleUserPrice ?? 0.0;
//       case 'Distributor':
//         return item.distributorPrice ?? 0.0;
//       case 'Superstockiest': // typo? maybe 'SuperstoreStockiest'
//         return item.superstorePrice ?? 0.0;
//       case 'Dealer':
//         return item.dealerPrice ?? 0.0;
//       case 'Retailer':
//         return item.retailerPrice ?? 0.0;
//       default:
//         return 0.0;
//     }
//   }
