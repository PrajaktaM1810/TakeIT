...
class Item {
  ...
  List<int>? singleUserQuantityTiers;
  List<int>? distributorQuantityTiers;
  List<int>? superstoreQuantityTiers;
  List<int>? dealerQuantityTiers;
  List<int>? retailerQuantityTiers;
  double? singleUserPrice;
  double? distributorPrice;
  double? superstorePrice;
  double? dealerPrice;
  ...
  Item({
    ...
    this.allergiesName,
    this.genericName,
    this.singleUserQuantityTiers,
    this.distributorQuantityTiers,
    this.superstoreQuantityTiers,
    this.dealerQuantityTiers,
    this.retailerQuantityTiers,
    this.singleUserPrice,
    this.distributorPrice,
    this.superstorePrice,
    this.dealerPrice,
    this.retailerPrice,
  });
  ...
  Item.fromJson(Map<String, dynamic> json) {
    ...
    singleUserQuantityTiers = json['single_user_quantity_tiers']?.cast<int>();
    distributorQuantityTiers = json['distributor_quantity_tiers']?.cast<int>();
    superstoreQuantityTiers = json['superstore_quantity_tiers']?.cast<int>();
    dealerQuantityTiers = json['dealer_quantity_tiers']?.cast<int>();
    retailerQuantityTiers = json['retailer_quantity_tiers']?.cast<int>();
    singleUserPrice = double.tryParse(json['single_user_price']?.toString() ?? '0');
    distributorPrice = double.tryParse(json['distributor_price']?.toString() ?? '0');
    superstorePrice = double.tryParse(json['superstore_price']?.toString() ?? '0');
    dealerPrice = double.tryParse(json['dealer_price']?.toString() ?? '0');
    retailerPrice = double.tryParse(json['retailer_price']?.toString() ?? '0');
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['single_user_quantity_tiers'] = singleUserQuantityTiers;
    data['distributor_quantity_tiers'] = distributorQuantityTiers;
    data['superstore_quantity_tiers'] = superstoreQuantityTiers;
    data['dealer_quantity_tiers'] = dealerQuantityTiers;
    data['retailer_quantity_tiers'] = retailerQuantityTiers;
    data['single_user_price'] = singleUserPrice;
    data['distributor_price'] = distributorPrice;
    data['superstore_price'] = superstorePrice;
    data['dealer_price'] = dealerPrice;
    data['retailer_price'] = retailerPrice;
    return data;
  }
}
