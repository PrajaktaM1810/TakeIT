...
//                         ),
//                         SizedBox(
//                             width: widget.item!.isStoreHalalActive! &&
...
//                   ),
//                   const SizedBox(width: Dimensions.paddingSizeSmall),
//                   widget.item!.availableTimeStarts != null
//                       ? const SizedBox()
//                       : Container(
//                           padding: const EdgeInsets.all(8),
//                           alignment: Alignment.center,
...
//                     ),
//                     child:
//                         Text(widget.inStock ? 'out_of_stock'.tr : 'in_stock'.tr,
//                             style: robotoRegular.copyWith(
//                               color: Theme.of(context).primaryColor,
//                               fontSize: Dimensions.fontSizeExtraSmall,
//                             )),
...
//                     } else {
//                       Get.offNamed(RouteHelper.getStoreRoute(
//                           id: widget.item!.storeId, page: 'item'));
//                     }
//                   },
//                   child: Padding(
//                     padding: const EdgeInsets.fromLTRB(0, 5, 5, 5),
...
//                       size: 18),
//                 SizedBox(
//                     height: widget.item!.ratingCount! > 0
//                         ? Dimensions.paddingSizeSmall
//                         : 0),
...
//                                 Wrap(
//                                     children: List.generate(
//                                         widget.item!.genericName!.length,
//                                         (index) {
//                                   return Text(
...
//                           pricePerUnit = itemController.item!.singleUserPrice;
//                           print(
//                               "Superstockiest${itemController.item!.singleUserPrice}");
//                         } else if (userType == 'Distributor') {
//                           pricePerUnit = itemController.item!.distributorPrice;
//                         } else if (userType == 'Superstockiest') {
//                           pricePerUnit = itemController.item!.superstorePrice;
//                         } else if (userType == 'Dealer') {
//                           pricePerUnit = itemController.item!.dealerPrice;
//                         } else if (userType == 'Retailer') {
//                           pricePerUnit = itemController.item!.retailerPrice;
//                         }
...
//                                     height: Dimensions.paddingSizeDefault),
//                                 OrganicTag(
//                                     item: widget.item!, fromDetails: true),
//                                 Container(
//                                   padding: const EdgeInsets.symmetric(
//                                       horizontal: Dimensions.paddingSizeSmall,
//                                       vertical:
