                        ...
                        child: Row(children: [
                          ...
                          DropdownButtonHideUnderline(
                            child: DropdownButton<int>(
                              ...
                              onChanged: cartController.isLoading
                                  ? null
                                  : (int? newValue) {
                                      if (newValue != null) {
                                        cartController.setQuantity(
                                          null, // isIncrement is null
                                          cartIndex,
                                          cart.stock,
                                          cart.quantityLimit,
                                          quantity:
                                              newValue, // 🔁 direct quantity update
                                        );
                                      }
                                    },

                              items: List.generate(
                                cart.stock! > 10 ? 10 : cart.stock!,
                                (index) => DropdownMenuItem<int>(
                                  value: index + 1,
                                  child: SizedBox(
                                    height: 40, // sets the height of each item
                                    child: Align(
                              ...
                              menuMaxHeight:
                                  160, // shows approx. 4 items max (4 * 40)
                            ),
                          ),
                          const SizedBox(width: 8),
                          // QuantityButton(
